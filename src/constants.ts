 ...
 * the signed-in account, including `account.email_address`. Used to label
 * stored accounts by their email so they're distinguishable in the account
 * store and failover debug logs.
 */
